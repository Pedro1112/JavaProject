...
public class WriteFile
{
	...
	public static void writeOwners()
	{
		...
		try
		{
			...
			output.format("%s;%s;%s;%s;%d\n", "Willis", "596 Dale Lane", "Forth Worth", "Texas", 76123);
			output.format("%s;%s;%s;%s;%d\n", "Traver", "512 Ball Court", "Burleson", "Texas", 76138);
			output.format("%s;%s;%s;%s;%d\n", "Merrit", "11 Flower Road", "North Richland Hills", "Texas", 77126);
	...
	public static void writeProperties()
	{
		...
		try
		{
			...
			output.format("%s,;%s,;%d,;%s,;%d,;%s,;%d,;%s,;%s,;%s\n", "Residential", "Jones", 12345, "111 W. 2nd St., Tulsa, Oklahoma, 58934", 135000, "1, 13, 2013", 1575, "TIER2", "True", "Stately Estates");
			...
			output.format("%s,;%s,;%d,;%s,;%d,;%s,;%d,;%s,;%s,;%s\n", "Residential", "Willis", 38767, "853 Third Avenue, New York, New York, 90123", 96000, "4, 3, 2008", 3025, "TIER3", "False", "Kingly Estates");
			
			output.format("%s,;%s,;%d,;%s,;%d,;%s,;%d,;%s,;%s,;%s\n", "Commercial", "Willis", 72634, "3865 Cooper St., Arlington, Texas, 76018", 235000, "5, 2, 1999", 1300, "TIER4", "Joe Paint Shop", "A546J");
			
			output.format("%s,;%s,;%d,;%s,;%d,;%s,;%d,;%s,;%s,;%s\n", "Commercial", "Jones", 14256, "111 Smart Rd., New Orleans, Louisiana, 34562", 65000, "7, 15, 2005", 5000, "TIER4", "Tacos Galore", "R782D");
